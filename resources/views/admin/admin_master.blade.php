...
<html lang="en">
    <head>
        ...
        <link href="{{asset('public/admin_assets/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
...
function checkDelete() {
    chk = confirm("Are you sure delete This??");
    if (chk) {
        return true;
    } else {
        return false;
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/manage-category')}}">
                        <i class="fas fa-fw fa-folder"></i>
                        <span>Manage Category</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/add-blog')}}">
                        <i class="fas fa-fw fa-folder"></i>
                        <span>Add Blog</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/manage-blog')}}">
                        <i class="fas fa-fw fa-folder"></i>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input class="btn btn-secondary" type="submit" data-dismiss="modal">Cancel</button>
        ...
        <script src="{{asset('public/admin_assets/vendor/datatables/jquery.dataTables.js')}}"></script>
        <script src="{{asset('public/admin_assets/vendor/datatables/dataTables.bootstrap4.js')}}"></script>

        <!-- Custom scripts for all pages-->
        <script src="{{asset('public/admin_assets/js/sb-admin.min.js')}}"></script>
